...
For more information, please see [this paper](http://ieeexplore.ieee.org/document/7497179/) or [this](../blob/master/docs/videoSinopsis_RPIC.pdf).
...
1. Download the [Dockerfile](../OpenSourceVS/Dockerfile/Dockerfile)
